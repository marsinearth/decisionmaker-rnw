...
var Picker = (function(_React$Component) {
  ...
  function Picker(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Picker.__proto__ || Object.getPrototypeOf(Picker)).call(this, props)
    );
    ...
    _this.onScrollChange = function() {
      ...
      if (top >= 0) {
        ...
        var index = _this.props.computeChildIndex(
          top,
          _this.itemHeight,
          children.length
        );
    ...
    _this.scrollingComplete = function() {
      var top = _this.scrollHanders.getValue();
      if (top >= 0) {
        _this.props.doScrollingComplete(
          top,
          _this.itemHeight,
          _this.fireValueChange
        );
      }
    };
  ...
  _createClass(Picker, [
    {
      ...
      value: function componentDidMount() {
        ...
        maskRef.style.backgroundSize = "100% " + (itemHeight * num + 24) + "px";
        maskRef.style.transform = "translateY(-18px)";
            ...
            this.setState(
              ...
              function() {
                _this4.props.select(
                  ...
                  _this4.itemHeight,
                  nextProps.noAnimate
                    ? _this4.scrollToWithoutAnimation
                    : _this4.scrollTo
                );
              }
            );
    ...
    },
    {
      ...
      value: function render() {
        ...
        var prefixCls = props.prefixCls,
          ...
          indicatorClassName =
            _props$indicatorClass === undefined ? "" : _props$indicatorClass,
          children = props.children;
        var selectedValue = this.state.selectedValue;

        var itemClassName = prefixCls + "-item";
        var selectedItemClassName =
          itemClassName + " " + prefixCls + "-item-selected";
        var map = function map(item) {
          var _item$props = item.props,
            _item$props$className = _item$props.className,
            className =
              _item$props$className === undefined ? "" : _item$props$className,
        ...
        var items = React.Children
          ? React.Children.map(children, map)
          : [].concat(children).map(map);
        var pickerCls =
          ((_pickerCls = {}),
          _defineProperty(_pickerCls, props.className, !!props.className),
          _defineProperty(_pickerCls, prefixCls, true),
          _pickerCls);
        return React.createElement(
          "div",
          {
