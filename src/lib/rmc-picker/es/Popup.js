...
var getModal = function getModal(props, visible, _ref) {
  ...
  return React.createElement(
    Modal,
    { prefixCls: '' + prefixCls, className: props.className || '', visible: true, closable: false, transitionName: props.transitionName || props.popupTransitionName, maskTransitionName: props.maskTransitionName, maskClosable: props.maskClosable, onClose: hide, style: props.style },
    React.createElement(
      'div',
      null,
      React.createElement(
